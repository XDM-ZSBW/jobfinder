    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-10 max-w-md mx-auto mb-12">
            <div className="mb-6">
              <div className="text-5xl font-bold text-gray-900 mb-2">
                $115<span className="text-xl font-normal text-gray-600">/week</span>
              </div>
              <p className="text-gray-600">Professional Job Matching Service</p>
              <p className="text-sm text-indigo-600 font-semibold mt-1">2 User Seats Included</p>
            </div>
          ...
          {/* Trial & Refund Policy */}
          <div id="subscribe" className="text-sm text-gray-600 max-w-2xl mx-auto mb-12">
            <p className="mb-2">
              <strong>Free Trial:</strong> Try JobMatch AI risk-free for 7 days. No charge until trial ends.
            </p>
            <p className="mb-2">
              <strong>Refund Policy:</strong> Full refund available within 14 days of first payment.
            </p>
            <p>
              After 14 days, credits available within 60 days with written correspondence.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <div className="mb-4">
              <p className="text-lg font-semibold text-white mb-2">Questions? We're Here to Help</p>
              <p className="text-sm">
                Text us at{' '}
                <a 
                  href="sms:(626)995-9974" 
              ...
              <p className="text-xs mt-1 text-gray-500">
                Twilio AI support line • Available soon
              </p>
            </div>
